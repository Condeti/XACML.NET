...
{
	/// <summary>
	/// A class defining the Date data type.
	/// </summary>
	public class DateDataType : inf.IDataType
	{
		#region Constructors
		...
		{ 
			get{ return InternalDataTypes.XsdDate; }
		}
		...
		{
			return XmlConvert.ToDateTime( value, "yyyy-MM-dd" );
		}
