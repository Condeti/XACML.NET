...
namespace Xacml.Core.Runtime.Functions
{
	...
	public class StringNormalizeToLowercase : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.StringNormalizeToLowercase; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			return new EvaluationValue( GetStringArgument( args, 0 ).ToLower( CultureInfo.InvariantCulture ), DataTypeDescriptor.String );
		}
		...
		public override inf.IDataType[] Arguments
		{
			get
			{
				return new inf.IDataType[]{ DataTypeDescriptor.String };
			}
		}
