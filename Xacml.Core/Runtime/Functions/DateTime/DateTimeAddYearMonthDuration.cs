...
namespace Xacml.Core.Runtime.Functions.DateTimeDataType
{
	...
	/// </summary>
	public class AddYearMonthDuration : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.DateTimeAddYearMonthDuration; }
		}
		...
		public override inf.IDataType[] Arguments
		{
			get
			{
				return new inf.IDataType[]{ DataTypeDescriptor.DateTime, DataTypeDescriptor.YearMonthDuration };
			}
		}
