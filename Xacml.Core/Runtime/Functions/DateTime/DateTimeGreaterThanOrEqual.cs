...
namespace Xacml.Core.Runtime.Functions.DateTimeDataType
{
	...
	/// </summary>
	public class GreaterThanOrEqual : BaseEqual
	{
		...
		{
			get{ return InternalFunctions.DateTimeGreaterThanOrEqual; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			if( GetDateTimeArgument( args, 0 ) >= GetDateTimeArgument( args, 1 ) )
			{
