...
namespace Xacml.Core.Runtime.Functions.DateTimeDataType
{
	/// <summary>
	...
	/// </summary>
	public class SubtractDaytimeDuration : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.DateTimeSubtractDaytimeDuration; }
		}
		...
		public override inf.IDataType[] Arguments
		{
			get
			{
				return new inf.IDataType[]{ DataTypeDescriptor.DateTime, DataTypeDescriptor.DaytimeDuration };
			}
		}
