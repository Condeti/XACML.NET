...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class DoubleGreaterThanOrEqual : BaseEqual
	{
		...
		{
			get{ return InternalFunctions.DoubleGreaterThanOrEqual; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			if( GetDoubleArgument( args, 0 ) >= GetDoubleArgument( args, 1 ) )
			{
