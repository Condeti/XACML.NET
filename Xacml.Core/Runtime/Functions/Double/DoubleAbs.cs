...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class DoubleAbs : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.DoubleAbs; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			return new EvaluationValue( Math.Abs( GetDoubleArgument( args, 0 ) ), DataTypeDescriptor.Double );
		}
