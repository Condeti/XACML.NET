...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class IntegerGreaterThanOrEqual : BaseEqual
	{
		...
		{
			get{ return InternalFunctions.IntegerGreaterThanOrEqual; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			if( GetIntegerArgument( args, 0 ) >= GetIntegerArgument( args, 1 ) )
			{
