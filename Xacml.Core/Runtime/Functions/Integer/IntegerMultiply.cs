...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class IntegerMultiply : BaseMathOperation
	{
		...
		{
			get{ return InternalFunctions.IntegerMultiply; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			return new EvaluationValue( GetIntegerArgument( args, 0 ) * GetIntegerArgument( args, 1 ), DataTypeDescriptor.Integer );
		}
