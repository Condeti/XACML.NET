...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class IntegerToDouble : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.IntegerToDouble; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			return new EvaluationValue( Convert.ToDouble( GetIntegerArgument( args, 0 ) ), DataTypeDescriptor.Double );
		}
		...
		public override inf.IDataType[] Arguments
		{
			get
			{
				return new inf.IDataType[]{ DataTypeDescriptor.Integer };
			}
		}
