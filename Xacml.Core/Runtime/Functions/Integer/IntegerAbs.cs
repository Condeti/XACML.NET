...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class IntegerAbs : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.IntegerAbs; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			return new EvaluationValue( Math.Abs( GetIntegerArgument( args, 0 ) ), DataTypeDescriptor.Integer );
		}
		...
		public override inf.IDataType[] Arguments
		{
			get
			{
				return new inf.IDataType[]{ DataTypeDescriptor.Double };
			}
		}
