...
namespace Xacml.Core.Runtime.Functions
{
	...
	public class NotFunction : FunctionBase
	{
		...
		{
			get{ return InternalFunctions.Not; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			return new EvaluationValue( !GetBooleanArgument( args, 0 ), DataTypeDescriptor.Boolean );
		}
		...
		public override inf.IDataType[] Arguments
		{
			get
			{
				return new inf.IDataType[]{ DataTypeDescriptor.Boolean };
			}
		}
