...
namespace Xacml.Core.Runtime.Functions
{
	...
	/// </summary>
	public class TimeLessThanOrEqual : BaseEqual
	{
		...
		{
			get{ return InternalFunctions.TimeLessThanOrEqual; }
		}
		...
		public override EvaluationValue Evaluate( EvaluationContext context, params inf.IFunctionParameter[] args )
		{
			...
			if( GetTimeArgument( args, 0 ) <= GetTimeArgument( args, 1 ) )
			{
		...
		{
			get{ return DataTypeDescriptor.Time; }
		}
