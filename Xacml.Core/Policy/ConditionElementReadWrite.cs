...
namespace Xacml.Core.Policy
{
	...
	public class ConditionElementReadWrite : ApplyBaseReadWrite
	{
		...
		public override void WriteDocument(XmlWriter writer)
		{
			...
			writer.WriteStartElement(PolicySchema1.ConditionElement.Condition);
			if( this.FunctionId != null && this.FunctionId.Length > 0 )
			{
				writer.WriteAttributeString(PolicySchema1.ConditionElement.FunctionId,this.FunctionId);
			}
