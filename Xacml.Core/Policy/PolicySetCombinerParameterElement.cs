...
namespace Xacml.Core.Policy
{
	...
	public class PolicySetCombinerParameterElement : CombinerParameterElement
	{
		...
		public PolicySetCombinerParameterElement( XmlReader reader, XacmlVersion version )
			: base( reader, PolicySchema2.PolicySetCombinerParameterElement.PolicySetCombinerParameter, version )
		{
		}
		...
		{
			if( reader.LocalName == PolicySchema2.PolicySetCombinerParameterElement.PolicySetIdRef )
			{
				_policySetIdRef = new Uri( reader.GetAttribute( PolicySchema2.PolicySetCombinerParameterElement.PolicySetIdRef ) );
			}
		}
