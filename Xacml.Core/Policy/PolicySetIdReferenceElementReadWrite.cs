...
namespace Xacml.Core.Policy
{
	...
	public class PolicySetIdReferenceElementReadWrite : XacmlElement
	{
			...
			: base( XacmlSchema.Policy, schemaVersion )
		{
			...
			if( reader.LocalName == PolicySchema1.PolicySetIdReferenceElement.PolicySetIdReference && 
		...
		public void WriteDocument( XmlWriter writer )
		{
			...
			writer.WriteElementString( PolicySchema1.PolicySetIdReferenceElement.PolicySetIdReference, this._policySetIdReference );
		}
