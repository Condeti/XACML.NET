...
namespace Xacml.Core.Policy
{
	...
	public class PolicyCombinerParameterElement : CombinerParameterElement
	{
		...
		public PolicyCombinerParameterElement( XmlReader reader, XacmlVersion version )
			: base( reader, PolicySchema2.PolicyCombinerParameterElement.PolicyCombinerParameter, version )
		{
		}
		...
		{
			if( reader.LocalName == PolicySchema2.PolicyCombinerParameterElement.PolicyIdRef )
			{
				_policyIdRef = new Uri( reader.GetAttribute( PolicySchema2.PolicyCombinerParameterElement.PolicyIdRef ) );
			}
		}
