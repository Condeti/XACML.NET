...
{
	/// <summary>
	/// Represents a read/write Resource node defined in the policy document. This class extends TargetItem
	/// since Sibject, Action and Resource share a similar document structure.
	/// </summary>
	public class ResourceElementReadWrite : TargetItemBaseReadWrite
	{
		#region Constructors
		...
		public ResourceElementReadWrite( TargetMatchReadWriteCollection match, XacmlVersion version )
			: base( match, version )
		{
		}
		...
		/// <param name="version">The version of the schema that was used to validate.</param>
		public ResourceElementReadWrite( XmlReader reader, XacmlVersion version ) 
			: base( reader, PolicySchema1.ResourceElement.Resource, PolicySchema1.ResourceElement.ResourceMatch, version )
		{
		}
		...
		{
			return new ResourceMatchElementReadWrite( reader, SchemaVersion );
		}
