...
namespace Xacml.Core.Policy
{
	...
	/// </summary>
	public class TargetMatchReadWriteCollection : CollectionBase 
	{
		...
		/// </summary>
		public virtual TargetMatchBaseReadWrite this[int index]
		{
            get { return (TargetMatchBaseReadWrite)this.List[index]; }
