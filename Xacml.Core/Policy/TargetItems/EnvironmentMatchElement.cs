...
{
	/// <summary>
	/// Represents a read-only Match found in an Environment element in the Policy document. This class extends the abstract 
	/// Match class which is used to mantain any Match element found in a target item.
	/// </summary>
	public class EnvironmentMatchElement : TargetMatchBase
	{
		#region Constructors
		...
		/// <param name="version">The version of the schema that was used to validate.</param>
		public EnvironmentMatchElement( XmlReader reader, XacmlVersion version ) : 
			base( reader, PolicySchema2.EnvironmentElement.EnvironmentMatch, PolicySchema1.EnvironmentAttributeDesignatorElement.EnvironmentAttributeDesignator, version )
		{
		}
