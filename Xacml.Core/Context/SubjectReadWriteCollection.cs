...
namespace Xacml.Core.Context
{
	...
	public class SubjectReadWriteCollection : CollectionBase 
	{
		...
		public void WriteDocument( XmlWriter writer )
		{
			...
			{
				writer.WriteStartElement( ContextSchema.RequestElement.Subject );
				if( subject.SubjectCategory != null && subject.SubjectCategory.Length > 0 )
				{
					writer.WriteAttributeString( ContextSchema.SubjectElement.SubjectCategory, subject.SubjectCategory );
				}
